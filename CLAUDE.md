...
## 次回やること（優先度順）
1. **[最高]** Beds24導入に伴う新アプリ設計・作成 — Beds24にない独自機能（下記「Beds24との機能比較」参照）を新アプリとして再構築。既存アプリの修正ではなく新規作成。Beds24のAPI連携で予約データを取得し、清掃スタッフ管理・募集・立候補・報酬計算等の独自機能を提供
